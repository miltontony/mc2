...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'OrganizationUserRelation'
        db.create_table(u'organizations_organizationuserrelation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'OrganizationUserRelation'
        db.delete_table(u'organizations_organizationuserrelation')
