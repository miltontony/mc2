...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.project_version'
        db.add_column(u'unicoremc_project', 'project_version',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.project_version'
        db.delete_column(u'unicoremc_project', 'project_version')
