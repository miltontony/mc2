...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.app_type'
        db.alter_column(u'unicoremc_project', 'app_type', self.gf('django.db.models.fields.CharField')(max_length=256))

    def backwards(self, orm):

        # Changing field 'Project.app_type'
        db.alter_column(u'unicoremc_project', 'app_type', self.gf('django.db.models.fields.CharField')(max_length=10))
