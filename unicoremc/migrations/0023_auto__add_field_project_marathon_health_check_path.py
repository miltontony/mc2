...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.marathon_health_check_path'
        db.add_column(u'unicoremc_project', 'marathon_health_check_path',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.marathon_health_check_path'
        db.delete_column(u'unicoremc_project', 'marathon_health_check_path')
