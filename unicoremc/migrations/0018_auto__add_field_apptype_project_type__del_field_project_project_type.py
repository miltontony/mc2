...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppType.project_type'
        db.add_column(u'unicoremc_apptype', 'project_type',
    ...
    def backwards(self, orm):
        # Deleting field 'AppType.project_type'
        db.delete_column(u'unicoremc_apptype', 'project_type')
