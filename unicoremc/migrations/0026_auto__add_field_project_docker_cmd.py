...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.docker_cmd'
        db.add_column(u'unicoremc_project', 'docker_cmd',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.docker_cmd'
        db.delete_column(u'unicoremc_project', 'docker_cmd')
