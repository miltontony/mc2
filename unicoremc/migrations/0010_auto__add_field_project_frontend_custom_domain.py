...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.frontend_custom_domain'
        db.add_column(u'unicoremc_project', 'frontend_custom_domain',
                      self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.frontend_custom_domain'
        db.delete_column(u'unicoremc_project', 'frontend_custom_domain')
