...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.marathon_cpus'
        db.add_column(u'unicoremc_project', 'marathon_cpus',
                      self.gf('django.db.models.fields.FloatField')(default=0.1),
                      keep_default=False)

        # Adding field 'Project.marathon_mem'
        db.add_column(u'unicoremc_project', 'marathon_mem',
                      self.gf('django.db.models.fields.FloatField')(default=50.0),
                      keep_default=False)

        # Adding field 'Project.marathon_instances'
        db.add_column(u'unicoremc_project', 'marathon_instances',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.marathon_cpus'
        db.delete_column(u'unicoremc_project', 'marathon_cpus')

        # Deleting field 'Project.marathon_mem'
        db.delete_column(u'unicoremc_project', 'marathon_mem')

        # Deleting field 'Project.marathon_instances'
        db.delete_column(u'unicoremc_project', 'marathon_instances')
    ...
    models = {
        ...
        u'unicoremc.project': {
            ...
            'marathon_mem': ('django.db.models.fields.FloatField', [], {'default': '50.0'}),
