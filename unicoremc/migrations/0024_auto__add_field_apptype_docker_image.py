...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppType.docker_image'
        db.add_column(u'unicoremc_apptype', 'docker_image',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AppType.docker_image'
        db.delete_column(u'unicoremc_apptype', 'docker_image')
