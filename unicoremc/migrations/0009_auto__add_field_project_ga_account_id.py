...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.ga_account_id'
        db.add_column(u'unicoremc_project', 'ga_account_id',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.ga_account_id'
        db.delete_column(u'unicoremc_project', 'ga_account_id')
