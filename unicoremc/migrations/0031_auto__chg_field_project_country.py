...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'unicoremc_project', 'country', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Project.country'
        raise RuntimeError("Cannot reverse this migration. 'Project.country' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Project.country'
        db.alter_column(u'unicoremc_project', 'country', self.gf('django.db.models.fields.CharField')(max_length=256))
    ...
    models = {
        ...
        u'unicoremc.project': {
            ...
            'custom_frontend_settings': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'docker_cmd': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'marathon_mem': ('django.db.models.fields.FloatField', [], {'default': '128.0'}),
