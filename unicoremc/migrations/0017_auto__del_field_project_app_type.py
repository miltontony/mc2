...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Project.app_type'
        db.delete_column(u'unicoremc_project', 'app_type')


    def backwards(self, orm):
        # Adding field 'Project.app_type'
        db.add_column(u'unicoremc_project', 'app_type',
    ...
    models = {
        ...
        u'unicoremc.project': {
            'Meta': {'ordering': "('application_type', 'country')", 'object_name': 'Project'},
