...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.hub_app_id'
        db.add_column(u'unicoremc_project', 'hub_app_id',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.hub_app_id'
        db.delete_column(u'unicoremc_project', 'hub_app_id')
