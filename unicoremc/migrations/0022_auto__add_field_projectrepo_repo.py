...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectRepo.repo'
        db.add_column(u'unicoremc_projectrepo', 'repo',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='repo_viewers', null=True, to=orm['unicoremc.ProjectRepo']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectRepo.repo'
        db.delete_column(u'unicoremc_projectrepo', 'repo_id')
    ...
    models = {
        ...
        u'unicoremc.projectrepo': {
            ...
            'repo': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'repo_viewers'", 'null': 'True', 'to': u"orm['unicoremc.ProjectRepo']"}),
