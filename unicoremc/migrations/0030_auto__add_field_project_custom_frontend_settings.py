...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.custom_frontend_settings'
        db.add_column(u'unicoremc_project', 'custom_frontend_settings',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.custom_frontend_settings'
        db.delete_column(u'unicoremc_project', 'custom_frontend_settings')
